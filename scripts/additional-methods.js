...
//validation for names; added by Andrei
jQuery.validator.addMethod("lettername", function(value, element) {
	return this.optional(element) || /^([ \u00c0-\u01ffa-zA-Z'\-])+$/i.test(value);
}, "Letters and ' - ONLY");  

//validation for post codes; added by Andrei
...
//basic validation for phone numbers; added by Andrei
jQuery.validator.addMethod("phoneNumber", function(value, element) {
	return this.optional(element) || /^[0-9\-\(\)\+ ]+$/i.test(value);
}, "Please enter a valid phone number");

jQuery.validator.addMethod("dateyyyymmdd", function(value, element) {
	return this.optional(element) || /^[1|2][0|9][0-9][0-9]\-[0|1][0-9]\-[0-3][0-9]$/i.test(value);
}, "Please enter a date in the valid format");
